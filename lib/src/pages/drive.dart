...
class _WheelRPM extends StatelessWidget {
  ...
  const _WheelRPM({required this.rpm, required this.color});
...
class _Wheels extends StatelessWidget {
  ...
  const _Wheels({required this.colors, required this.wheels});
      ...
      Expanded(
        child: Row(
          ...
          children: [
            Expanded(
              child: _Wheels(
                wheels: model.wheelsRPM,
                colors: model.wheelColors,
              ),
            ),
            Expanded(
              child: _BarChart(values: [model.leftWheels, -model.rightWheels]),
            ),
          ],
        ),
      ),
