...
enum OperatingMode {
  ...
  ///
  /// Normally, the base station code tracks the rover via GPS and aligns the antenna optimally,
  /// but this mode allows users to bypass that and control the antenna manually.
  antenna("Antenna");
