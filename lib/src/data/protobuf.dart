...
String getCommandName(Device device) => switch (device) {
  Device.ARM => ArmCommand().messageName,
  Device.CONTROL_BOARD => ControlCommand().messageName,
  Device.SCIENCE => ScienceCommand().messageName,
  Device.DRIVE => DriveCommand().messageName,
  Device.RELAY => RelaysCommand().messageName,
  Device.ANTENNA => AntennaFirmwareCommand().messageName,
  _ => "Unknown",
};
...
extension CoordinatesUtils on Translation3d {
...
extension DeviceUtils on Device {
  ...
  String get humanName {
    switch(this) {
      ...
      case Device.CONTROL_BOARD: return "Control Board";
    }
    // Do not use default or else you'll lose exhaustiveness checking.
